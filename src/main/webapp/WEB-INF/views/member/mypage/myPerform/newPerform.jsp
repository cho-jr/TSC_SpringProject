		...
		<div style="width:1000px;margin:0 auto;">
			...
			<div class="row" style="width:990px;margin:0;">
				...
				<div id="detail" class="col-9 p-0">
					<h3 style="text-align: center;">작품 등록 신청서</h3>
					<section>
						<div class="container-fluid p-0">
							<form class="form-group" name="myform" method="post" enctype="multipart/form-data" action="${ctp}/member/mypage/myPerform/newPerform">
								<table class="table" id="inputTable">
									<tr>
										<th class="table-danger">담당자</th>
										<td colspan="3">
											<div class="input-group">
												<input type="text" name="manager" id="manager" value="${email}" class="form-control" required readonly/>
											</div>
										</td>
									</tr>				
									<tr>
									...
									<tr>
										...
										<td colspan="3">
											<textarea rows="6" name="content" id="CKEDITOR" class="form-control" required>
												...
												<b>[공지사항]</b><br/>
												<p>
													<!-- <img src="/cjs2108_cjr/performImg/info/220103094025_@culture_banner.jpg" /> -->
												</p><br/>
												<b>[할인정보]</b><br/><br/>
												<b>[상세정보]</b><br/><br/>
